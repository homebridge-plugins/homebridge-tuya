...
export default class LocationWeatherAccessory extends BaseAccessory {
  ...
  constructor(platform: TuyaPlatform, accessory: PlatformAccessory<TuyaPluginAccessoryContext>) {
    ...
    this.weatherConditionTuya = {
      ...
      air_quality: { o3: '0', pm10: '0', co: '0', no2: '0', pm25: '0', so2: '0', aqi: '0' },
      current_weather: {
        temp: '0', real_feel: '0', uvi: '0', pressure: '0', condition: '0', condition_num: '0',
    ...
    this.weatherConditionOpenMeteo = {
      ...
      elevation: 0,
      current_units: { time: '', interval: '', temperature_2m: '', relative_humidity_2m: '' },
      current: { time: '', interval: 0, temperature_2m: 0, relative_humidity_2m: 0 },
    };
  }
  ...
  override configureServices() {
    if (this.platform.platformConfig.cloud?.weatherAPI === 'Tuya') {
