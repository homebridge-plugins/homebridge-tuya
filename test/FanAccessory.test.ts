...
import FanAccessory from '../src/shared/accessory/FanAccessory';
...
jest.mock('../src/shared/accessory/characteristic/Light', () => ({
  configureLight: (...args: any[]) => mockConfigureLight(...args),
}));
jest.mock('../src/shared/accessory/characteristic/On', () => ({
  configureOn: (...args: any[]) => mockConfigureOn(...args),
}));
jest.mock('../src/shared/accessory/characteristic/Active');
jest.mock('../src/shared/accessory/characteristic/RotationSpeed');
jest.mock('../src/shared/accessory/characteristic/SwingMode');
jest.mock('../src/shared/accessory/characteristic/LockPhysicalControls');
