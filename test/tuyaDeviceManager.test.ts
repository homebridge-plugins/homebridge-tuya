...
import { TuyaPlatformHomeConfig } from '../src/config';
...
describe('TuyaDeviceManager', () => 
  {
    ...
    let mockAPI: any;
    let mockConfig: TuyaPlatformHomeConfig;
    ...
    beforeEach(() => {
      ...
      manager = new TuyaHomeDeviceManager(mockAPI, mockConfig, false);
    });
    ...
    describe('initialization', () => {
      ...
      test('initializes with debug enabled', () => {
        const debugManager = new TuyaHomeDeviceManager(mockAPI, mockConfig, true);
      ...
      test('creates logger', () => {
        ...
        expect((manager['log'] as any).prefix).toEqual('TuyaHomeDeviceManager');
      });
    ...
    describe('MQTT integration', () => {
      test('adds message listener on init', () => {
        const newManager = new TuyaHomeDeviceManager(mockAPI, mockConfig, false);
    ...
    describe('multiple manager instances', () => {
      test('maintain separate device lists', () => {
        const manager1 = new TuyaHomeDeviceManager(mockAPI, mockConfig, false);
        const manager2 = new TuyaHomeDeviceManager(mockAPI, mockConfig, false);
